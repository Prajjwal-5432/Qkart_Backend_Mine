...
describe("Cart routes", () => {
  describe("Checkout", () => {
    ...
    it("should return 204 if cart is valid", async () => {
      ...
      // expect(res.body).toHaveProperty("cartItems"); // Check if "cartItems" property exists
      // expect(res.body.cartItems).toHaveLength(0); // Check if "cartItems" array has a length of 0
